# Post 9 — „Polizisten spielen Schläge vor, damit die Kamera lernt"
...
- **Warum es den Zuschauer betrifft:** Wer über den Mannheimer Bahnhofsvorplatz läuft, wird gefilmt und sein
  Bewegungsablauf von einer Software eingeordnet. Hamburg testet bereits, Heidelberg ist vorgesehen.
- **Ton:** nüchtern beschreibend, menschlich formuliert. Keine Überwachungsstaat-Rhetorik, keine Bewertung
  der Rechtmäßigkeit. Der Post fragt nach dem Beleg, nicht nach Gesinnung.
...
> In Mannheim wertet seit Dezember 2018 eine Software das Verhalten von Passanten aus. Damit sie Schläge
> und Stürze erkennt, spielen Polizisten solche Szenen selbst nach, mit Bodenmatte und Drehbuch. Rund
> 2.000 Filme sind gedreht, 10.000 sind geplant.
>
> Die spannende Frage ist nicht, ob das unheimlich klingt, sondern ob es funktioniert. Da wird es dünn. Das
> Innenministerium hat dem Landtag im Dezember 2023 geschrieben, dass die Software zwar Alarme erzeugt,
> diese aber ausschließlich zur Weiterentwicklung genutzt und nicht einheitlich protokolliert werden.
> Auswerten lässt sich deshalb nicht, wie viel sie tatsächlich erkennt. Eine Marktreife war nicht erreicht.
> Die 552 polizeilich relevanten Vorgänge, die 2023 gezählt wurden, fand das Videobeobachtungspersonal an
> der herkömmlichen Technik.
>
> Das Projekt endet im November 2026, die wissenschaftliche Auswertung ist für Anfang 2027 geplant.
> Ausgeweitet wird trotzdem schon: Hamburg testet seit 2025, Heidelberg ist als nächster Standort
> vorgesehen.
>
> Dazu kommt eine offene Rechtsfrage. Am Nordende der Breiten Straße, einem der überwachten Orte,
> verzeichnet die Kriminalstatistik seit 2017 keine Delikte. Das Polizeigesetz von Baden-Württemberg
> verlangt für solche Überwachung, dass sich die Kriminalitätsbelastung deutlich vom übrigen Stadtgebiet
> abhebt. Ob das hier zutrifft, hat ein Gericht nicht entschieden.
>
> Quellen auf dem letzten Blatt. Kein Rechtsrat.
> Fehler gefunden? Schreib es in die Kommentare, ich korrigiere sichtbar.
>
> #Videoüberwachung #Mannheim #KünstlicheIntelligenz #Polizei #Grundrechte #Datenschutz #Überwachung
...
Damit es bei 6 Blättern bleibt, liegen zwei belegte Punkte nur in `sources.md` und hier:

- **Der Widerspruch zwischen zwei amtlichen Quellen.** Fünf Wochen nach der Stellungnahme berichtete der
  Innenausschuss, das System habe „mehrfach" Straftaten und Notfälle früh erkannt, ohne Zahl. Guter Stoff
  für die Antwort auf Nachfragen in den Kommentaren.
- **Verzerrungsrisiko der Trainingsdaten.** Die Szenen werden überwiegend von Polizisten gespielt. Ein
  Informatiker warnt vor schlechterer Erkennung bei Frauen und BIPoC. Eigener Post denkbar.

## Vor dem Posten

- [x] Kernbefund an der Primärquelle geprüft (Landtag BW 17/5816, Stellungnahme vom 12.12.2023, Volltext).
- [x] Rechtsformulierungen beschreibend, keine Bewertung der Rechtmäßigkeit.
- [x] Gerendert, `slides/` gefüllt (6 Blätter, 14.08.2026).
- [ ] **Offen vor `geprueft`:** Die Zahlen für 2026 (68/72 Kameras, 59 angeschlossen, 17 Muster,
      2.000/10.000 Filme) stammen aus einer einzigen journalistischen Quelle. Gegenprüfen oder als
      Recherchestand kennzeichnen.
- [ ] **Offen:** Ob seit Dezember 2023 protokolliert wird, ist nicht dokumentiert. Blatt 04 datiert die
      Aussage deshalb ausdrücklich.
